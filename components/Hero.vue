...
<div class="bg-gradient-to-b from-white via-green-100 to-green-200  text-white px-6 md:px-12 lg:px-24 py-12 md:py-16 lg:py-24">
    ...
    <div class="text-center lg:text-left lg:-mt-16">
        ...
        <a type="button" href="https://www.linkedin.com/in/dasieroger" target="_blank" class="text-white bg-[#366ec7] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
