    ...
    <div class="bg-gradient-to-r from-white from-10% via-green-100 via-50% to-white-100 to-100% text-white px-64 py-32">
        <div class="flex justify-between items-center py-4">
            <div class="w-1/2 pr-8">
                ...
                <h2 id="animated-text" class="text-xl mt-2 font-bold text-green-800 ml-16">
                    Developpeur & Formateur
                </h2>
                <p class="text-gray-600 mt-4 text-md text-justify">Je suis passionné par la création d'expériences web
                    exceptionnelles. Avec une solide expérience en développement web, je mets mes compétences au service
                    de la réalisation de projets innovants. En tant que formateur, j'aspire à partager mes connaissances
